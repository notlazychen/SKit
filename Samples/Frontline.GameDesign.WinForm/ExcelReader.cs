                            ...
                            try
                            {
                                if (prop.Key.PropertyType == typeof(int))
                                {
                                    if (cell.CellType == CellType.String)
                                    {
                                        ...
                                        prop.Key.SetValue(instance, numb);
                                    }
                                    else
                                    {
                                        prop.Key.SetValue(instance, Convert.ToInt32(cell.NumericCellValue));
                                    }
                                }
                                else if (prop.Key.PropertyType == typeof(double))
                                {
                                    prop.Key.SetValue(instance, Convert.ToDouble(cell.NumericCellValue));
                                }
                                else if (prop.Key.PropertyType == typeof(float))
                                {
                                    prop.Key.SetValue(instance, Convert.ToSingle(cell.NumericCellValue));
                                }
                                else if (prop.Key.PropertyType == typeof(bool))
                                {
                                    prop.Key.SetValue(instance, Convert.ToBoolean(cell.NumericCellValue));
                                }
                                ...
                                {
                                    prop.Key.SetValue(instance, cell.StringCellValue);
                                }
                                else if (prop.Key.PropertyType == typeof(TimeSpan))
                                {
                                    if (cell.CellType == CellType.Numeric)
                                    {
                                        ...
                                        prop.Key.SetValue(instance, ts);
                                    }
                                    else
                                    {
                                        TimeSpan ts = TimeSpan.Parse(cell.StringCellValue);
                                        prop.Key.SetValue(instance, ts);
                                        string[] hms = cell.StringCellValue.Substring(cell.StringCellValue.IndexOf(".") + 1).Split(new[] { ':'});
                                ...
                                else if (prop.Key.PropertyType == typeof(JsonObject<int[]>))
                                {
                                    if (!string.IsNullOrEmpty(cell.StringCellValue))
                                    {
                                        ...
                                        prop.Key.SetValue(instance, new JsonObject<int[]>(ts));
                                    }
                                }
                                else if (prop.Key.PropertyType == typeof(JsonObject<float[]>))
                                {
                                    if (!string.IsNullOrEmpty(cell.StringCellValue))
                                    {
                                        ...
                                        prop.Key.SetValue(instance, new JsonObject<float[]>(ts));
                                    }
                                }
                                else if (prop.Key.PropertyType == typeof(JsonObject<List<int>>))
                                {
                                    if (!string.IsNullOrEmpty(cell.StringCellValue))
                                    {
                                        ...
                                        prop.Key.SetValue(instance, new JsonObject<List<int>>(ts));
                                    }
                                }
                                else
                                {
